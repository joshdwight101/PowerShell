...
public class CodexPulseLauncherForm : Form
{
    ...
    private void BuildLayout()
    {
        ...
        _refreshButton.Location = new Point(500, 126);
        ...
        _launchButton.Location = new Point(612, 126);
        ...
        _openButton.Location = new Point(772, 126);
        _openButton.Size = new Size(120, 30);

        _scriptsView.Location = new Point(24, 171);
        _scriptsView.Size = new Size(1060, 455);
        ...
        _pathLabel.Location = new Point(24, 662);
        ...
        _statusLabel.Location = new Point(24, 686);
        ...
        _autoRefreshCheck.Location = new Point(867, 131);
        _autoRefreshCheck.Size = new Size(108, 24);

        var secondsLabel = new Label { Text = "sec", ForeColor = Color.FromArgb(148, 163, 184), AutoSize = true, Location = new Point(1042, 132) };
        ...
        _browseRootButton.Location = new Point(978, 657);
        ...
        Controls.Add(_statusLabel); Controls.Add(folderLabel); Controls.Add(_rootPathBox); Controls.Add(_browseRootButton);
        Controls.Add(_autoRefreshCheck); Controls.Add(_refreshSeconds); Controls.Add(secondsLabel);

        folderLabel.BringToFront();
        _rootPathBox.BringToFront();
        _browseRootButton.BringToFront();
    }
