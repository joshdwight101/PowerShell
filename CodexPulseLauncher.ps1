...
public class CodexPulseLauncherForm : Form
{
    ...
    private void BuildLayout()
    {
        ...
        _searchBox.Size = new Size(350, 30);
        ...
        _refreshButton.Location = new Point(390, 126);
        ...
        _launchButton.Location = new Point(502, 126);
        ...
        _openButton.Location = new Point(662, 126);
